...
if old not in content:
    print("ERROR: old block not found — trying to check current state")
    import re
    if "open_db_trades_live" in content:
        print("Partial patch already present — inspect manually")
    else:
        print("No trace of prior patch found either — something else is wrong")
else:
